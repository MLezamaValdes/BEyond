...
mapview(buek200_lscs, zcol="Symbol", legend=FALSE)
...
TandemX Daten 12m ESA Research Proposal
https://sss.terrasar-x.dlr.de/
Mewing frequency 
Landuse intensity
Marvin Satellitenzeitreihe Landscape Metrics package Jakub Jahreskomposit (DLM Daten)
