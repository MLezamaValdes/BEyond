...
Most explo plots belong to soil type Rendzina (RR), Niedermoor (HN), Parabraunerde (LL), Pararendzina (RZ), Gley (GG)...
[Overview Bodentyp](https://de.wikipedia.org/wiki/Bodentyp)
...
![Interesting Maps BGR](interesting_Maps_BGR.png) somehow not able to download them in bulk... 
