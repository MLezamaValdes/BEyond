...
agri_ger <- mask(agri_ger, ger)

mapview(agri_ger)
writeRaster(agri_ger, paste0(cp, "/corine_agricultural_area_2018/cor_agri_2018_ger.tif"), overwrite=T)
...
writeRaster(grass_ger, paste0(cp, "/Grassland_2018_Germany/grassland_ger_HRL.tif"), overwrite=T)
```
...
![](flaechenbodenform_erlaeuterung.png) aus [BUEK300](https://lbgr.brandenburg.de/sixcms/media.php/9/BGB-1-2_03_Kuehn_53-60.pdf)
...
### Soil data to think about (To do \@ meeting)

More soil parameters (pH, P content, ... ) modeled based on Grassland samples in GEMAS (Geochemical Mapping of Agricultural and Grazing Land Soil in Europe) data

![GEMAS Grassland sampling sites](GEMAS_Grassland_samples.png)

(1:18 000 000, though..). Here to compare with our study sites:

![pH GEMAS](pH_GEMAS_resolution.png)

More parameters [here](https://geoportal.bgr.de/mapapps/resources/apps/geoportal/index.html?lang=de#/datasets/portal/b5d4d9ab-153c-4c51-a19c-cc81a62f9b7b)

![GEMAS Parameter, Indizes](GEMAS_Parameter_Indizes.png)
...
![Interesting Maps BGR](interesting_Maps_BGR.png){width="330"}

somehow not able to download them in bulk...

#### Use this dataset?!

[EUROPEAN SOIL DATA CENTRE (ESDAC)](https://esdac.jrc.ec.europa.eu/resource-type/european-soil-database-soil-properties) data requested:

**Maps of Soil Chemical properties at European scale based on LUCAS 2009/2012 topsoil data**

![](Ballabio_maps.png){width="638"}

500m resolution

![pH in H20 data (viridis) with HEG explo points](pH_example.png)
...
![](European_Soil_Database.png){width="495"}

![](European_Soil_Database_II.png){width="405"}
